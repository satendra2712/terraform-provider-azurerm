...
* `route` - (Optional) List of objects representing routes. Each object accepts the arguments documented below. This argument is processed in [attribute-as-blocks mode](/docs/configuration/attr-as-blocks.html).
