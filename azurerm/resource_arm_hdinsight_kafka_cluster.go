				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"worker_node": func() *schema.Schema {
							...
							maxNumberOfDisks := 8
							return azure.SchemaHDInsightNodeDefinition("roles.0.worker_node", canSpecifyCount, minInstanceCount, maxInstanceCount, validVmSizes, canSpecifyDisks, &maxNumberOfDisks)
						}(),
...
func resourceArmHDInsightKafkaClusterCreate(d *schema.ResourceData, meta interface{}) error {
	...
	roles, err := expandHDInsightKafkaRoles(rolesRaw)
	if err != nil {
...
func resourceArmHDInsightKafkaClusterRead(d *schema.ResourceData, meta interface{}) error {
	...
	if props := resp.Properties; props != nil {
		...
		if err := d.Set("roles", flattenHDInsightKafkaRoles(d, props.ComputeProfile)); err != nil {
...
func expandHDInsightKafkaRoles(input []interface{}) (*[]hdinsight.Role, error) {
...
func flattenHDInsightKafkaRoles(d *schema.ResourceData, input *hdinsight.ComputeProfile) []interface{} {
