...
func resourceArmHDInsightInteractiveQueryClusterCreate(d *schema.ResourceData, meta interface{}) error {
	...
	roles, err := expandHDInsightRoles(rolesRaw,
		hdInsightInteractiveQueryClusterHeadNodeDefinition,
		hdInsightInteractiveQueryClusterWorkerNodeDefinition,
		hdInsightInteractiveQueryClusterZookeeperNodeDefinition)
	if err != nil {
